    ...
    <x-slot name="main">
       ...
       @endif
        ...
        <div class="row mb-2">
                ...
                <div class="row mb-2">
                    <div class="col">
                        <label for="coffreType"><h5>Type de coffre:</h5></label><br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="coffreType" id="radioEspece" value="espèce">
                    ...
                    <div class="col">
                        <div id="checkInput" style="display: none;">
                            ...
                            <br>
                            <button type="button" class="btn btn-success mt-2" id="addCheckBtn">Ajouter un chèque</button>
                        </div>
                    </div>
                </div>
        ...
        @endif
            document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (primaryMagazineId) {
                        ...
                        .then(data => {
                            ...
                            data.forEach(charge => {
                                ...
                                chargeLabel.textContent = charge.charge_name + " - " + charge.charge_amount + " DH";
                                ...
                                primaryMagazineChargesList.appendChild(document.createElement("br"));
                            });
                ...
                ajouterButton.addEventListener("click", function() {
                    ...
                    var selectedCharges = [];
                    var selectedChargeCheckboxes = document.querySelectorAll("input[name='selectedCharges[]']:checked");
